...
class Seg_Actigraphy:
    ...
    def inclinometersStateChanging(self):
        ...
        self.df1['incl_activity']=arr_act
    ...
    def plotActigraphy(self):
        self.arr_fig[0], self.arr_axs[0] = plt.subplots(nrows=6, ncols=1, sharex=True)
    ...
    def plotSignals(self,fig,ax):
        ...
        ax[5].plot(self.df1['signal'].to_numpy())
