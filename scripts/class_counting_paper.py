...
##        fig_vm, ax_vm = plt.subplots(nrows=2, ncols=1,figsize=(10, 2))
        ...
        fig2 = plt.figure(figsize=(10, 3))
        cols = 8
        gs = fig2.add_gridspec(4,cols)
        ax0 = fig2.add_subplot(gs[0, 0:cols-1])
        ax1 = fig2.add_subplot(gs[1, 0:cols-1])
        ax2 = fig2.add_subplot(gs[2, 0:cols-1])
        ax3 = fig2.add_subplot(gs[3, 0:cols-1])
        # ax4 = fig2.add_subplot(gs[:, 2])
        ax5 = fig2.add_subplot(gs[1, cols-1])
        ax6 = fig2.add_subplot(gs[2, cols-1])
        ax7 = fig2.add_subplot(gs[3, cols-1])
...
##        self.plotVerticalLines(ax, indices_vertical_lines)
        ...
        # ax[0].plot(arr_vec_mag,   color='tab:purple', label='VM (counts)')
        ax1.plot(arr_sw_001min, alpha=0.5, color='tab:brown', )
        ax2.plot(arr_sw_015min, alpha=0.5, color='tab:pink',  )
        ax3.plot(arr_sw_030min, alpha=0.5, color='tab:gray',  )
        ...
        # ax4.boxplot(data, showfliers=False, labels=['SM_1min', 'SM_15min', 'SM_30min'])
        ax5.boxplot(data[0], showfliers=False, )
        ax6.boxplot(data[1], showfliers=False, )
        ax7.boxplot(data[2], showfliers=False, )
        ...
        y_end=  1.2
        # ax4.set_ylim(y_ini,y_end)
        ax5.set_ylim(y_ini,y_end)
        ax6.set_ylim(y_ini,y_end)
        ax7.set_ylim(y_ini,y_end)
