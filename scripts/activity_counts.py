...
if __name__== '__main__':
    ...
    for sample in files_list:
        df1 = pd.read_csv(path+sample, header=header_location, decimal=',', usecols=['Date',' Time', 'Vector Magnitude'])
        # print(df1.columns)
        ...
        for night_num in nights_list:
            ...
            df_mag = df_nights.loc[(df_nights['night']==night_num), ['Vector Magnitude']]
            ...
            activity, inactivity, start_active = non_motion_periods(df_mag)
