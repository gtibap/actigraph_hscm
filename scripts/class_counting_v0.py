...
class Counting_Actigraphy:
    ...
    def counting_repositioning(self):
        ...
        for night_num in nights_list:
            ...
            df_per_n = pd.DataFrame([], columns=['hour', 'off_lyi', 'off_sit', 'off_sta', 'lyi_off', 'lyi_sit', 'lyi_sta', 'sit_off', 'sit_lyi', 'sit_sta', 'sta_off', 'sta_lyi', 'sta_sit'])
            ...
            for id_h in np.arange(num_hours): 
                ...
                df_per_h = pd.DataFrame([[id_h, off_lyi, off_sit, off_sta, lyi_off, lyi_sit, lyi_sta, sit_off, sit_lyi, sit_sta, sta_off, sta_lyi, sta_sit]], columns=['hour', 'off_lyi', 'off_sit', 'off_sta', 'lyi_off', 'lyi_sit', 'lyi_sta', 'sit_off', 'sit_lyi', 'sit_sta', 'sta_off', 'sta_lyi', 'sta_sit'])
                
                df_per_n=pd.concat([df_per_n, df_per_h], ignore_index=True)
