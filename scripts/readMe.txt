...
rw_mattress_data.py
reads .csv files of the pressure mattress generated by Tactilus software and writes the data using numpy to facilitate data visualization with matplotlib. This process generates two files: one header and one raw.
